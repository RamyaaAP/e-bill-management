                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-bordered table-condensed">
                                ...
                                <tbody>
                                    <?php 
                                    $id=$_SESSION['uid'];
                                    $query1 = "SELECT COUNT(*) FROM complaint where userid={$id}";
                                    $result1 = mysqli_query($con,$query1);
                                    $row1 = mysqli_fetch_row($result1);
                                    $numrows = $row1[0];
                                    include("paging_1.php");

                                    $result = retrieve_user_complaints($_SESSION['uid'],$offset, $rowsperpage);
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal new_complaint"  role="form"  action="subcomplaint.php" method="post">
